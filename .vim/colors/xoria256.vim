...
hi Normal   cterm=none  ctermfg=252 gui=none    guifg=#d0d0d0   guibg=#202020

hi Cursor   cterm=none  ctermbg=214 gui=none    guifg=bg    guibg=#ffaf00
...
hi WarningMsg   cterm=bold  ctermfg=196   gui=bold    guifg=#ff0000   guibg=bg
hi ModeMsg  cterm=bold  ctermfg=fg    gui=bold    guifg=fg    guibg=bg
hi MoreMsg  cterm=bold  ctermfg=250   gui=bold    guifg=#bcbcbc   guibg=bg
hi Question cterm=bold  ctermfg=113   gui=bold    guifg=#87df7f   guibg=bg
...
hi SignColumn   cterm=none  ctermfg=248   gui=none    guifg=#a8a8a8   guibg=bg

hi Directory    cterm=none  ctermfg=39    gui=none    guifg=#00afff   guibg=bg
hi LineNr   cterm=none  ctermfg=248         gui=none    guifg=#a8a8a8
hi NonText  cterm=bold  ctermfg=248   gui=bold    guifg=#a8a8a8   guibg=bg
hi SpecialKey   cterm=none  ctermfg=77    gui=none    guifg=#5fdf5f   guibg=bg
...
hi VisualNOS    cterm=bold,underline ctermfg=247  gui=bold,underline guifg=#9e9e9e guibg=bg

hi Comment  cterm=none  ctermfg=244   gui=none    guifg=#808080   guibg=bg
""" COLD
hi Constant cterm=none  ctermfg=187   gui=none    guifg=#dfdfaf   guibg=bg
""" COLD-DARK
"hi Constant    cterm=none  ctermfg=223   gui=none    guifg=#ffdfaf   guibg=bg
""" NEUTRAL
"hi Constant    cterm=none  ctermfg=229   gui=none    guifg=#ffffaf   guibg=bg
""" WARM
"hi Constant    cterm=none  ctermfg=222   gui=none    guifg=#ffdf87   guibg=bg
"hi String  cterm=      ctermfg=    ctermbg=    gui=        guifg=      guibg=
hi Error    cterm=none  ctermfg=196   gui=none    guifg=#ff0000   guibg=bg
""" COLD
"hi Identifier  cterm=none  ctermfg=115   gui=none    guifg=#87dfaf   guibg=bg
""" NEUTRAL
"hi Identifier  cterm=none  ctermfg=114   gui=none    guifg=#87df87   guibg=bg
""" WARM
hi Identifier   cterm=none  ctermfg=150   gui=none    guifg=#afdf87   guibg=bg
hi Ignore   cterm=none  ctermfg=238   gui=none    guifg=#444444   guibg=bg
hi Number   cterm=none  ctermfg=180   gui=none    guifg=#dfaf87   guibg=bg
"hi Number  cterm=none  ctermfg=222   gui=none    guifg=#ffaf87   guibg=bg
"hi Number  cterm=none  ctermfg=215   gui=none    guifg=#ffaf87   guibg=bg
...
hi PreProc  cterm=none  ctermfg=182   gui=none    guifg=#dfafdf   guibg=bg
"hi PreProc cterm=none  ctermfg=218   gui=none    guifg=#ffafdf   guibg=bg
""" LIGHT
"hi Special cterm=none  ctermfg=174   gui=none    guifg=#ffafaf   guibg=bg
""" DARK
hi Special  cterm=none  ctermfg=174   gui=none    guifg=#df8787   guibg=bg
"hi Special cterm=none  ctermfg=114   gui=none    guifg=#87df87   guibg=bg
"hi SpecialChar cterm=      ctermfg=    ctermbg=    gui=        guifg=      guibg=
hi Statement    cterm=none  ctermfg=74    gui=none    guifg=#5fafdf   guibg=bg
"hi Statement   cterm=none  ctermfg=75    gui=none    guifg=#5fafff   guibg=bg
hi Todo     cterm=none  ctermfg=0   ctermbg=184 gui=none    guifg=#000000   guibg=#dfdf00
"hi Type        cterm=none  ctermfg=153   gui=none    guifg=#afdfff   guibg=bg
hi Type     cterm=none  ctermfg=146   gui=none    guifg=#afafdf   guibg=bg
hi Underlined   cterm=underline ctermfg=39    gui=underline   guifg=#00afff   guibg=bg
...
if v:version >= 700
  ...
  hi PmenuThumb cterm=none  ctermbg=252 gui=none    guifg=bg    guibg=#d0d0d0
  ...
  hi TabLineSel cterm=bold  ctermfg=fg    gui=bold    guifg=fg    guibg=bg
